		...
		<?php
			while ($row = $team_players->fetch(PDO::FETCH_ASSOC)) {
				...
				$player_row .= '<td>';
					...
					$april_player_total->bindParam(2, $seasonid, PDO::PARAM_INT, 11);
				...
				$player_row .= '<td>';
					...
					$may_player_total->bindParam(2, $seasonid, PDO::PARAM_INT, 11);
				...
				$player_row .= '<td>';
					...
					$june_player_total->bindParam(2, $seasonid, PDO::PARAM_INT, 11);
				...
				$player_row .= '<td>';
					...
					$july_player_total->bindParam(2, $seasonid, PDO::PARAM_INT, 11);
				...
				$player_row .= '<td>';
					...
					$august_player_total->bindParam(2, $seasonid, PDO::PARAM_INT, 11);
				...
				$player_row .= '<td>';
					...
					$september_player_total->bindParam(2, $seasonid, PDO::PARAM_INT, 11);
			...
			$team_column_totals = '<tr class="table-primary">';
				...
				$team_column_totals .= '<td>';
					...
					$team_players_march_total->bindParam(1, $leagueid, PDO::PARAM_INT, 11);
					$team_players_march_total->bindParam(2, $team_id, PDO::PARAM_INT, 11);
					$team_players_march_total->bindParam(3, $seasonid, PDO::PARAM_INT, 11);
				...
				$team_column_totals .= '<td>';
					...
					$team_players_april_total->bindParam(1, $leagueid, PDO::PARAM_INT, 11);
					$team_players_april_total->bindParam(2, $team_id, PDO::PARAM_INT, 11);
					$team_players_april_total->bindParam(3, $seasonid, PDO::PARAM_INT, 11);
				...
				$team_column_totals .= '<td>';
					...
					$team_players_may_total->bindParam(1, $leagueid, PDO::PARAM_INT, 11);
					$team_players_may_total->bindParam(2, $team_id, PDO::PARAM_INT, 11);
					$team_players_may_total->bindParam(3, $seasonid, PDO::PARAM_INT, 11);
				...
				$team_column_totals .= '<td>';
					...
					$team_players_june_total->bindParam(1, $leagueid, PDO::PARAM_INT, 11);
					$team_players_june_total->bindParam(2, $team_id, PDO::PARAM_INT, 11);
					$team_players_june_total->bindParam(3, $seasonid, PDO::PARAM_INT, 11);
				...
				$team_column_totals .= '<td>';
					...
					$team_players_july_total->bindParam(1, $leagueid, PDO::PARAM_INT, 11);
					$team_players_july_total->bindParam(2, $team_id, PDO::PARAM_INT, 11);
					$team_players_july_total->bindParam(3, $seasonid, PDO::PARAM_INT, 11);
				...
				$team_column_totals .= '<td>';
					...
					$team_players_august_total->bindParam(1, $leagueid, PDO::PARAM_INT, 11);
					$team_players_august_total->bindParam(2, $team_id, PDO::PARAM_INT, 11);
					$team_players_august_total->bindParam(3, $seasonid, PDO::PARAM_INT, 11);
				...
				$team_column_totals .= '<td>';
					...
					$team_players_september_total->bindParam(1, $leagueid, PDO::PARAM_INT, 11);
					$team_players_september_total->bindParam(2, $team_id, PDO::PARAM_INT, 11);
					$team_players_september_total->bindParam(3, $seasonid, PDO::PARAM_INT, 11);
