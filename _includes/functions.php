...
ORDER BY ru.first_name, ru.last_name");
		$stmt->execute();
	...
	// This function build an array of unquire player records based on the key it is passed.  In our case we pass the player_id key.
