...
<div class="container table-responsive-sm">
  <h1><?php print $GLOBALS["active_season_name"]; ?> Season Leader Board<div style="float:right;font-size: 0.5em;">last updated: <?php print get_last_updated_date($league_id,$season_id);?></div></h1>  
      ...
      <?php
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
          ...
          $team_row .= '<td>';
            ...
            $march_query->bindParam(2, $season_id, PDO::PARAM_INT, 11);
            $march_query->execute();
          ...
          $team_row .= '<td>';
            ...
            $april_query->bindParam(2, $season_id, PDO::PARAM_INT, 11);
            $april_query->execute();
          ...
          $team_row .= '<td>';
            ...
            $may_query->bindParam(2, $season_id, PDO::PARAM_INT, 11);
            $may_query->execute();
          ...
          $team_row .= '<td>';
            ...
            $june_query->bindParam(2, $season_id, PDO::PARAM_INT, 11);
            $june_query->execute();
          ...
          $team_row .= '<td>';
            ...
            $july_query->bindParam(2, $season_id, PDO::PARAM_INT, 11);
            $july_query->execute();
          ...
          $team_row .= '<td>';
            ...
            $august_query->bindParam(2, $season_id, PDO::PARAM_INT, 11);
          ...
          $team_row .= '<td>';
            ...
            $september_query->bindParam(2, $season_id, PDO::PARAM_INT, 11);
          ...
          $team_row .= '<td>';
            ...
            $october_query->bindParam(2, $season_id, PDO::PARAM_INT, 11);
          ...
          $team_row .= '<td>';
            ...
            $total_query->bindParam(2, $season_id, PDO::PARAM_INT, 11);
            $total_query->bindParam(3, $league_id, PDO::PARAM_INT, 11);
            $total_query->execute();
